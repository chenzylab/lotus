...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: 'CodeHighlight 代码高亮', href: '/show/code-highlight' },
      { text: 'MarkdownRender Markdown 渲染', href: '/show/markdown-render' },
      { text: 'JsonViewer JSON 查看器', href: '/show/json-viewer' },
      { text: 'OverflowList 溢出列表', href: '/show/overflow-list' },
      { text: 'ScrollList 滚动选择列表', href: '/show/scroll-list' },
      { text: 'UserGuide 用户引导', href: '/show/user-guide' },
      { text: 'Lottie 动画', href: '/show/lottie' },
