...
export const routes = [
  ...
  renderRoute({ path: '/input/auto-complete', entry: '/src/pages/input/auto-complete.tsrx' }),
  renderRoute({ path: '/input/cascader', entry: '/src/pages/input/cascader.tsrx' }),
  renderRoute({ path: '/input/color-picker', entry: '/src/pages/input/color-picker.tsrx' }),
  renderRoute({ path: '/input/date-picker', entry: '/src/pages/input/date-picker.tsrx' }),
  renderRoute({ path: '/input/pin-code', entry: '/src/pages/input/pin-code.tsrx' }),
  renderRoute({ path: '/input/rating', entry: '/src/pages/input/rating.tsrx' }),
  renderRoute({ path: '/input/slider', entry: '/src/pages/input/slider.tsrx' }),
  ...
  renderRoute({ path: '/show/audio-player', entry: '/src/pages/show/audio-player.tsrx' }),
  renderRoute({ path: '/show/badge', entry: '/src/pages/show/badge.tsrx' }),
  renderRoute({ path: '/show/calendar', entry: '/src/pages/show/calendar.tsrx' }),
  renderRoute({ path: '/show/card', entry: '/src/pages/show/card.tsrx' }),
  renderRoute({ path: '/show/carousel', entry: '/src/pages/show/carousel.tsrx' }),
  renderRoute({ path: '/show/collapse', entry: '/src/pages/show/collapse.tsrx' }),
  renderRoute({ path: '/show/collapsible', entry: '/src/pages/show/collapsible.tsrx' }),
  renderRoute({ path: '/show/cropper', entry: '/src/pages/show/cropper.tsrx' }),
  renderRoute({ path: '/show/descriptions', entry: '/src/pages/show/descriptions.tsrx' }),
  renderRoute({ path: '/show/empty', entry: '/src/pages/show/empty.tsrx' }),
  renderRoute({ path: '/show/highlight', entry: '/src/pages/show/highlight.tsrx' }),
  renderRoute({ path: '/show/image', entry: '/src/pages/show/image.tsrx' }),
  renderRoute({ path: '/show/list', entry: '/src/pages/show/list.tsrx' }),
  renderRoute({ path: '/show/timeline', entry: '/src/pages/show/timeline.tsrx' }),
  renderRoute({ path: '/show/code-highlight', entry: '/src/pages/show/code-highlight.tsrx' }),
  renderRoute({ path: '/show/markdown-render', entry: '/src/pages/show/markdown-render.tsrx' }),
  renderRoute({ path: '/show/json-viewer', entry: '/src/pages/show/json-viewer.tsrx' }),
  renderRoute({ path: '/show/overflow-list', entry: '/src/pages/show/overflow-list.tsrx' }),
  renderRoute({ path: '/show/scroll-list', entry: '/src/pages/show/scroll-list.tsrx' }),
  renderRoute({ path: '/show/user-guide', entry: '/src/pages/show/user-guide.tsrx' }),
  renderRoute({ path: '/show/lottie', entry: '/src/pages/show/lottie.tsrx' }),
