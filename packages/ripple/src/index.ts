...
export { Checkbox, type CheckboxProps, type CheckboxApi } from './input/checkbox/index.tsrx';
export {
    CheckboxGroup,
...
export {
    ...
    type ContainerProps as SidebarContainerProps,
    Options as SidebarOptions,
    type OptionsProps as SidebarOptionsProps,
    type SidebarOption,
    CodeContent as SidebarCodeContent,
    type CodeContentProps as SidebarCodeContentProps,
    type CodeItem as SidebarCodeItem,
    Annotation as SidebarAnnotation,
    type AnnotationProps as SidebarAnnotationProps,
    type AnnotationGroup as SidebarAnnotationGroup,
    type AnnotationItem as SidebarAnnotationItem,
    MCPConfigure as SidebarMCPConfigure,
    type MCPConfigureProps as SidebarMCPConfigureProps,
    type MCPOption as SidebarMCPOption,
    type MCPMode as SidebarMCPMode,
    FileContent as SidebarFileContent,
    type FileContentProps as SidebarFileContentProps,
    type FileContentItem as SidebarFileContentItem,
    FileItem as SidebarFileItem,
